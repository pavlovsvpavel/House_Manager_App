...
sudo docker-compose -f docker-compose.aws.yml exec -T web python manage.py makemessages -l bg
sudo docker-compose -f docker-compose.aws.yml exec -T web python manage.py compilemessages
